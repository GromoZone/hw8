...
public class Main {
    ...
    human.actions("пробежал", "проплыл");
    cat.actions("пробежал", "проплыл");
    robot.actions("пробежал", "проплыл\n");

        System.out.println("Задание №2.");

    human.barriers("пробежал по беговой дорожке", "прыгнул через стену");
    cat.barriers("пробежал по беговой дорожке", "прыгнул через стену");
    robot.barriers("пробежал по беговой дорожке", "прыгнул через стену\n");
    }
}